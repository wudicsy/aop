...
//
//
//    @Pointcut("execution(* com.example.testlibrary.android.app.Activity.onCreate(..))")
//    public void activityOnCreate1()
//    {
//        //empty method body
//    }
//
//
//    @Around("activityOnCreate1()")
//    public void activityOnCreate1Triggered(ProceedingJoinPoint joinPoint) throws Throwable
//    {
//        String targetClassName = joinPoint.getTarget().getClass().getName();
//        String signatureName = joinPoint.getSignature().getName();
//        Log.d(TAG, targetClassName + " " + signatureName + " before");
